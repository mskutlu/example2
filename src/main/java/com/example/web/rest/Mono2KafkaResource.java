...
@RestController
@RequestMapping("/api/mono-2-kafka")
public class Mono2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Mono2KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Mono2KafkaResource(KafkaProperties kafkaProperties) {
